...
To get signed off at Level 1, you will need to be able to show me an RStudio project that contains the data and a script that:

* Activates the appropriate libraries
* Loads in the data set above
...
If you are already feeling confident in R then just submit me a project with a current plot you are working on for your summer research so I can see where you're at and see how I can help you level-up.

I can come see this on your computer or you can zip the project folder and submit it to the Google Classroom assignment below.
