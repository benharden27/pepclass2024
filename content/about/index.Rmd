...
The PEP class is built to help prepare you for thework you will be doing this summer and beyond. This includes allowing you to:
...
Once you've completed this self-assessment, we will work together to determine an appropriate assessment model on a one-to-one basis. This will essentially be a grading contract that we can use to determine if you're meeting the goals of leveling-up your skills in this class. I'll work with you to determine an achievable plan. We'll have a chance to review this mid-term, but the basic idea is that if you meet the goals set out then it's an A. Partial fulfillment is a B and little/no demonstrated progress a C.

### Class Times and Your Research Internship

Class will be most Monday mornings and Thurs evenings. In this period we'll have both synchronous and asynchronous class work. I will be available to you during this time and we expect you to be available for full-class, small group and individual interaction as needed.
